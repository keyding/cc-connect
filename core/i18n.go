...
const (
	...
	MsgBuildSupportExcluded      MsgKey = "build_support_excluded"
...
const (
	...
	MsgSharedMessageCount       MsgKey = "shared_message_count"
...
var messages = map[MsgKey]map[Language]string{
	...
	MsgQueueTitle: {
		...
		LangChinese:            "会话 :%s（%s）\n\n任务队列：\n",
		LangTraditionalChinese: "會話 :%s（%s）\n\n任務佇列：\n",
		LangJapanese:           "会話：%s（%s）\n\nタスクキュー：\n",
		LangSpanish:            "Sesión: %s (%s)\n\nCola de tareas:\n",
	},
	MsgQueueEntry: {
		LangEnglish:            "%[3]s %[1]s (%[2]s)",
		LangChinese:            "%[3]s %[1]s（%[2]s）",
		LangTraditionalChinese: "%[3]s %[1]s（%[2]s）",
		LangJapanese:           "%[3]s %[1]s（%[2]s）",
		LangSpanish:            "%[3]s %[1]s (%[2]s)",
	},
	MsgQueueDenied: {
	...
	MsgSharedMessageCount: {
		LangEnglish:            "Messages: %d",
		LangChinese:            "%d 条消息",
		LangTraditionalChinese: "%d 則訊息",
	...
	MsgSharedCurrent: {
		...
		LangChinese:            "💬 当前会话：%s\n\n[%s] (%s)",
		LangTraditionalChinese: "💬 目前會話：%s\n\n[%s] (%s)",
		LangJapanese:           "💬 現在の会話：%s\n\n[%s] (%s)",
		LangSpanish:            "💬 Sesión actual: %s\n\n[%s] (%s)",
	},
	...
	MsgBuildSupportExcluded: {
		LangEnglish:            "%s support was excluded from this build.",
		LangChinese:            "此构建未包含 %s 支持。",
		LangTraditionalChinese: "此建置未包含 %s 支援。",
		LangJapanese:           "このビルドには %s のサポートが含まれていません。",
		LangSpanish:            "Esta compilación no incluye soporte para %s.",
	},
	MsgUnknownCommand: {
